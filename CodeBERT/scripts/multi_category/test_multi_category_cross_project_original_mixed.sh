...
exec python $code_path/multi_category/run2_multi_category_cross_project.py \
...
--do_eval \
--train_data_file=$data_path/train_full_columns.csv \
--eval_data_file=$data_path/valid_full_columns.csv \
--test_data_file=$data_path/test_full_columns.csv \
--epoch 20 \
--block_size 400 \
--train_batch_size 32 \
--eval_batch_size 64 \
