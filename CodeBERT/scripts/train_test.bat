python run.py --output_folder_name=balanced10 --output_dir=./saved_models --model_type=roberta --tokenizer_name=microsoft/codebert-base --model_name_or_path=microsoft/codebert-base --do_train --train_data_file=../dataset/balanced_1.0/train.jsonl --eval_data_file=../dataset/balanced_1.0/valid.jsonl --test_data_file=../dataset/balanced_1.0/test.jsonl --epoch 5 --block_size 400 --train_batch_size 32 --eval_batch_size 64 --learning_rate 2e-5 --max_grad_norm 1.0 --evaluate_during_training --seed 123456


python run.py --output_folder_name=balanced10 --output_dir=./saved_models --model_type=roberta --tokenizer_name=microsoft/codebert-base --model_name_or_path=microsoft/codebert-base --do_eval --do_test --train_data_file=../dataset/balanced_1.0/train.jsonl --eval_data_file=../dataset/balanced_1.0/valid.jsonl --test_data_file=../dataset/balanced_1.0/test.jsonl --epoch 5 --block_size 400 --train_batch_size 32 --eval_batch_size 64 --learning_rate 2e-5 --max_grad_norm 1.0 --evaluate_during_training --seed 123456
...
python run.py --output_folder_name=balanced09 --output_dir=./saved_models --model_type=roberta --tokenizer_name=microsoft/codebert-base --model_name_or_path=microsoft/codebert-base --do_train --train_data_file=../dataset/balanced_0.9/train.jsonl --eval_data_file=../dataset/balanced_0.9/valid.jsonl --test_data_file=../dataset/balanced_0.9/test.jsonl --epoch 5 --block_size 400 --train_batch_size 32 --eval_batch_size 64 --learning_rate 2e-5 --max_grad_norm 1.0 --evaluate_during_training --seed 123456


python run.py --output_folder_name=balanced09 --output_dir=./saved_models --model_type=roberta --tokenizer_name=microsoft/codebert-base --model_name_or_path=microsoft/codebert-base --do_eval --do_test --train_data_file=../dataset/balanced_0.9/train.jsonl --eval_data_file=../dataset/balanced_0.9/valid.jsonl --test_data_file=../dataset/balanced_0.9/test.jsonl --epoch 5 --block_size 400 --train_batch_size 32 --eval_batch_size 64 --learning_rate 2e-5 --max_grad_norm 1.0 --evaluate_during_training --seed 123456
