        ...
        for filename in filenames:
            ...
            if not node_mapped_linevul_tokens_concat==[] and node_mapped_linevul_tokens_concat is not None:
                ...
                if file_id_only in linevul_token_scores_dict:
                    ...
                    full_write_path = full_path.replace("XFG_LineVul_Map", "XFG_Intersection_Visual_X_Times_CodeBERT_Map")
                    ...
                    with open(full_write_path, "w") as f:
                        json.dump({"file_id":file_id,
                                        "original_code":original_code,
                                        "CodeBERT_Tokens": linevul_token_scores_dict[file_id_only],
                                        "slicing_node_mapped_CodeBERT_tokens_concat":node_mapped_linevul_tokens_concat,
