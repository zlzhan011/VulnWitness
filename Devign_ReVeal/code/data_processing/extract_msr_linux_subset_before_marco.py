...
import os
sample = False
print(os.listdir('../data/MSR_Linux_before_marco_preprocess/'))
df = pd.read_csv("../data/MSR_Linux_before_marco_preprocess/MSR_data_cleaned.csv", index_col=0, nrows=5 if sample else None)
# df
print(df.head(1))
#%%
...
import os
code_dir = "../data/MSR_Linux_before_marco_preprocess/raw_code"
...
with open("../data/MSR_Linux_before_marco_preprocess/files.txt", "w") as f:
