...
# ggnn_json_data = json.load(open('../data/ggnn_input/Synthetic_V3_cfg_full_text_files.json'))
# files = [d['file_name'] for d in ggnn_json_data]

# df = pd.read_csv(f"{data_dir}/Synthetic_V3_data_cleaned.csv", index_col=0)
