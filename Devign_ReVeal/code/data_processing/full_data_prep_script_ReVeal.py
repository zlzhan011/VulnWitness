...
# extract_graph_data('ReVeal', 'full_graph')
import sys
extract_graph_data("ReVeal", 'full_graph')
...
# extract_token_data('ReVeal', 'vuld')
# extract_token_data('ReVeal', 'syse')
# extract_token_data('ReVeal', 'draper')
...
def extract_line_graph_data(project):
    ...
    with jsonlines.open(os.path.join(output_dir, project + '-line-ggnn.jsonlines'), "w") as writer:
        for file_name in tqdm(files):
            ...
            if os.path.isfile(nodes_file_path):
                pass
            else:
                skip_cnt = skip_cnt + 1
...
graph_data = extract_line_graph_data("ReVeal")
...
# graph_data = extract_line_graph_data("ReVeal_modified")
