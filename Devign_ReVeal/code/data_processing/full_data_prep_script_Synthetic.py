...
# extract_graph_data('Synthetic_V3', 'full_graph')
import sys
extract_graph_data("Synthetic_V3", 'full_graph')
...
# extract_token_data('Synthetic_V3', 'vuld')
# extract_token_data('Synthetic_V3', 'syse')
# extract_token_data('Synthetic_V3', 'draper')
...
graph_data = extract_line_graph_data("Synthetic_V3")
...
# graph_data = extract_line_graph_data("Synthetic_V3_modified")
