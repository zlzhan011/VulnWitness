...
import tqdm
import os
print(os.listdir('../data/Devign/linevul_splits'))
# exit()
...
# feat_df = pd.read_json("data/Devign/full_experiment_real_data_processed/Devign-full_graph.jsonlines", lines=True)
...
#%%
# splits_df = pd.read_csv("../data/Devign/linevul_splits/splits.csv")

splits_df = pd.read_csv("../data/Devign/linevul_splits/splits.csv").rename(columns={"index": "id"})
# splits_df
...
#%%
merge_df.to_csv("../data/Devign/full_experiment_real_data_processed/vlinevul/splits.csv")
merge_df.to_csv("../data/Devign/full_experiment_real_data_processed/vDevign/splits.csv")

# splitscsv_df = pd.read_csv("../data/Devign/full_experiment_real_data_processed/vlinevul/splits.csv")
# # splitscsv_df
#
# #%%
