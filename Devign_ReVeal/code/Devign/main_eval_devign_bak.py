...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='MSR', type=str, required=True, help='Name of the dataset for experiment.')
    parser.add_argument('--input_dir',
                        ...
                        type=str, required=True, help='Input Directory of the parser')
    parser.add_argument('--fold', default='MSR', required=True, help='Which fold of the dataset to load')
    ...
    model_dir = "models2/MSR/ggnn/vMSR/1234"
    if args.train:
    ...
    if args.holdout or args.holdout_test:
        ...
        save_path = 'models2/MSR/ggnn/vMSR/1234/GGNNSumModel' + '-model.bin'
