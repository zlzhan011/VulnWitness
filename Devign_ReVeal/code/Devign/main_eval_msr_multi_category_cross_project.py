...
from trainer import train, evaluate_metrics, train_multi_category
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default=True, action="store_true", help='Do training')
    ...
    # processed_data_path = os.path.join(input_dir, 'processed_multi_category_cross_project_resample_bak.bin')
    ...
    if not args.no_split:
        ...
        splits_reveal = dataset.load_splits(all_src, splits_dir, args.mega_cool_mode,
                                            args.shport)
