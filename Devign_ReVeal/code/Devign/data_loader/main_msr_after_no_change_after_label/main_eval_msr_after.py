...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default=True, help='Do training')
    ...
    args.paired_flag = True
    args.filter_flag = False
    args.debug_mode = True
    args.multi_category = False
    args.training_add_after_into_before = True
    ...
    if not args.no_split:
        ...
        splits_reveal = dataset.load_splits(all_src, os.path.join(splits_dir, 'splits.csv'), args.mega_cool_mode,
                                            args.shport)
    ...
    if args.train:
        ...
        train(model=model, dataset=dataset, max_steps=1000000000, dev_every=64, log_every=None,
              ...
              save_path=model_dir + '/GGNNSumModel' + "_paired_flag_" + str(args.paired_flag), max_patience=100000, args=args)
    ...
    if args.holdout or args.holdout_test:
        ...
        with torch.no_grad():
            ...
            print("Run test  all_files_name 0_100:", all_files_name[:100])
