...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='ReVeal', type=str,  help='Name of the dataset for experiment.')
    parser.add_argument('--input_dir',
                        default='/data/cs_lzhan011/data/cs_lzhan011/vulnerability/data-package/models/Devign_ReVeal/code/data/ReVeal/full_experiment_real_data_processed',
                        type=str, help='Input Directory of the parser')
    parser.add_argument('--fold', default='ReVeal',  help='Which fold of the dataset to load')
    ...
    parser.add_argument('--save_after_ggnn', default=False, action="store_true", help='Evaluate all examples and export them')
    ...
    args.training_add_after_into_before = False
