...
from trainer import train, evaluate_metrics, do_test_test
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test', default=True, action="store_true", help='Do training')
    ...
    if args.test:
        ...
        do_test_test(model=model, dataset=dataset, max_steps=1000000000, dev_every=64, log_every=None,
              loss_function=loss_function, optimizer=optim,
              save_path=model_dir + '/GGNNSumModel', max_patience=100000)
